...
class AgendaCalendarForm extends TWindow
{
    ...
    private static $formName = 'form_AgendaCalendarForm';
    ...
    {
        parent::__construct();
        parent::setSize(0.90, null);
        parent::setTitle("Calendário de agendamento");
        ...
        $button_incluir1 = new TButton('button_incluir1');
        $button_pagamento = new TButton('button_pagamento');
        ...
        $button_incluir->setAction(new TAction(['ClientesForm', 'onShow']), "Incluir");
        $button_incluir1->setAction(new TAction(['ServicosForm', 'onShow']), "Incluir");
        $button_pagamento->setAction(new TAction(['PagamentosForm', 'onShow']), "Pagamento");

        $button_pagamento->addStyleClass('btn-info');
        $button_incluir->addStyleClass('btn-success');
        $button_incluir1->addStyleClass('btn-success');

        $button_incluir->setImage('fas:ad #FFFFFF');
        $button_incluir1->setImage('fas:ad #FFFFFF');
        $button_pagamento->setImage('fas:money-bill-alt #FFFFFF');

        $id->setSize(100);
        $cor->setSize(100);
        $clientes_id->setSize('83%');
        $servicos_id->setSize('77%');
        ...
        $row2 = $this->form->addFields([new TLabel("Cliente:", '#3F51B5', '14px', null, '100%'),$clientes_id,$button_incluir],[new TLabel("Profissional:", '#3F51B5', '14px', null, '100%'),$profissionais_id]);
        $row2->layout = [' col-sm-8',' col-sm-4'];

        $row3 = $this->form->addFields([new TLabel("Serviço:", '#3F51B5', '14px', null, '100%'),$servicos_id,$button_incluir1],[$button_pagamento]);
        $row3->layout = [' col-sm-8',' col-sm-3'];

        $row4 = $this->form->addFields([new TLabel("Hora inicial:", null, '14px', null, '100%'),$horario_inicial],[new TLabel("Hora final:", null, '14px', null, '100%'),$horario_final],[new TLabel("Cor:", null, '14px', null, '100%'),$cor]);
        $row4->layout = [' col-sm-3',' col-sm-3',' col-sm-4'];
