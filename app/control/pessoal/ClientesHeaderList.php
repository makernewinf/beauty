...
class ClientesHeaderList extends TWindow
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        parent::setTitle("Cadastro de clientes");
    ...
    <div class='col-sm-12' style='text-align:center; padding-top:30px; padding-bottom:30px;'>
        <div class="container">
          <i style = 'font-size:60px; margin-bottom:15px;color:#F44336' class="fas fa-info-circle"></i>
