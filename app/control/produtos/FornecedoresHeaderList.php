...
class FornecedoresHeaderList extends TWindow
{
    private $form; // form
    ...
    private static $formName = 'formList_Fornecedores';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('FornecedoresForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('FornecedoresHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Fornecedores");
        ...
        $button_cadastrar->setAction(new TAction(['FornecedoresForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['FornecedoresHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['FornecedoresHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Fornecedores($key, FALSE); 
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->telefone) AND ( (is_scalar($data->telefone) AND $data->telefone !== '') OR (is_array($data->telefone) AND (!empty($data->telefone)) )) )
        {
            ...
            $filters[] = new TFilter('telefone', '=', $data->telefone);// create the filter 
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Fornecedores
